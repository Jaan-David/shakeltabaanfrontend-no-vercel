...
export default async function ProductByIdPage({
  ...
  try {
    ...
    const data: ProductData = {
      ...
      priceOnRequest: apiProduct.priceOnRequest,
      customPriceLabel: apiProduct.customPriceLabel,
      pricePerSquareMeter: apiProduct.pricePerSquareMeter,
      offerSquarePrice: apiProduct.offerSquarePrice,
      pricePerLinearMeter: apiProduct.pricePerLinearMeter,
      pricePerCubicMeter: apiProduct.pricePerCubicMeter,
      offerLinearPrice: apiProduct.offerLinearPrice,
      offerCubicPrice: apiProduct.offerCubicPrice,
