      ...
      <div className="relative w-full h-[280px] sm:h-[360px] md:h-[420px] lg:h-[480px]">
        ...
        >
          <div className="w-full max-w-2xl space-y-4 sm:space-y-6 text-center">
            <h1
              id="hero-title"
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white drop-shadow-lg leading-tight"
            >
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center pt-2 sm:pt-4">
              <Link
                href="/products"
                className="inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 active:scale-95 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold transition-all duration-200 shadow-lg hover:shadow-xl w-full sm:w-auto min-h-[44px]"
              >
                <Zap size={18} />
                تصفح المنتجات
              </Link>
              ...
              <Link
                href="/inquiries"
                className="inline-flex items-center justify-center gap-2 bg-white/95 hover:bg-white text-blue-600 px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold transition-all duration-200 shadow-lg hover:shadow-xl w-full sm:w-auto min-h-[44px]"
              >
                <Star size={18} />
                طلب مخصص
              </Link>
          ...
          <div className="flex flex-col gap-6" dir="rtl">
            <div className="space-y-3">
              ...
              <p className="text-lg text-slate-600">
                هل لديك احتياجات خاصة؟ فريقنا جاهز لتقديم حلول مصممة خصيصاً لك
              </p>
            </div>
    ...
    <section className="py-12 sm:py-16 md:py-20 px-4" aria-labelledby="products-title">
      <div className="mx-auto max-w-6xl">
        ...
        {loading ? (
          ...
          // Products Grid
          <div className="grid gap-4 sm:gap-5 md:gap-6 grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
