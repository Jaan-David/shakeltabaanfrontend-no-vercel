      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-8 sm:gap-12 px-4 py-8 sm:py-12">
        ...
        <div className="border-t border-slate-800 pt-6 sm:pt-8 text-center text-xs sm:text-sm text-slate-400 space-y-2">
          ...
          <div className="flex gap-4 justify-center text-xs pt-2">
            <Link href="/policies/privacy" className="hover:text-slate-300 transition">
              سياسة الخصوصية
            </Link>
            <span>•</span>
            <Link href="/policies/terms" className="hover:text-slate-300 transition">
              الشروط والأحكام
            </Link>
          </div>
        </div>
  ...
  return (
    <div className="border border-slate-700 rounded-lg overflow-hidden">
      ...
      {isOpen && (
        <div
          id={`accordion-${title}`}
          className="px-4 py-4 bg-slate-850 text-slate-300"
        >
          {children}
        </div>
      )}
