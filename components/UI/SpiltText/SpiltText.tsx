...
const SplitText: React.FC<SplitTextProps> = ({
  ...
  useGSAP(
    () => {
      ...
      // Use 'words' as default for Arabic text instead of 'chars'
      const effectiveSplitType = shouldUseArabicMode && splitType === 'chars' ? 'words' : splitType;
        ...
        onSplit: (self: GSAPSplitText) => {
          ...
          if (shouldUseArabicMode) {
            targets.forEach((target: Element) => {
              ...
              htmlTarget.style.display = 'inline-block';
              htmlTarget.style.whiteSpace = 'nowrap';
              // Maintain RTL direction for Arabic
              htmlTarget.style.direction = 'rtl';
              htmlTarget.style.unicodeBidi = 'embed';
            });
          }
