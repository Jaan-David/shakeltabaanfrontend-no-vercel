...
const Ratings: React.FC<Props> = ({
  ...
  if (loading) {
    return (
      <section className="bg-white backdrop-blur-sm rounded-2xl border border-gray-200 shadow-sm p-4 sm:p-6">
        <div className="text-right text-slate-600">جاري تحميل التقييمات...</div>
      </section>
    );
  }
  ...
  if (error) {
    return (
      <section className="bg-white backdrop-blur-sm rounded-2xl border border-gray-200 shadow-sm p-4 sm:p-6">
        <div className="text-right text-red-500">خطأ في تحميل التقييمات: {error}</div>
      </section>
    );
  }
  ...
  if (total === 0) {
    return (
      <section className="bg-white backdrop-blur-sm rounded-2xl border border-gray-200 shadow-sm p-4 sm:p-6">
        <h2 className="text-right text-lg sm:text-xl font-bold text-blue-900 mb-3">الآراء حول هذا المنتج</h2>
        <div className="text-right text-slate-600">لا توجد تقييمات بعد</div>
      </section>
    );
  }
  ...
  return (
    <section className="bg-white backdrop-blur-sm rounded-2xl border border-gray-200 shadow-sm p-4 sm:p-6">
      ...
      <div className="text-right text-slate-500 text-xs mb-4">
