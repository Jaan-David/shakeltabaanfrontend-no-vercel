...
const Specs: React.FC<Props> = ({ specs }) => {
  ...
  return (
    <section className="bg-white rounded-2xl border border-gray-200 shadow-sm p-4 sm:p-6">
      <h2 className="text-right text-lg sm:text-xl font-bold text-blue-900 mb-3 sm:mb-4">مواصفات المنتج</h2>
      <ul className="text-right list-disc list-inside space-y-2 sm:space-y-2.5 text-slate-600 leading-relaxed">
        {specs.map((s, idx) => {
