export const API_ENDPOINTS = {
  ...
  AUTH: {
    ...
    ACTIVE_CODE: '/users/OTPResend',//POST
  ...
  // Wishlist/Favorites
  WISHLIST: {
    GET: '/wish-items',              // GET all wishlist items
    ADD: '/wish-items',              // POST to add item
    REMOVE: '/wish-items/:productId', // DELETE to remove item
    MOVE_TO_CART: '/wishlist/move-to-cart/:id', // Not in API docs yet
  },
